...
const QuestionEvaluation = ({
	...
	return (
		<>
			<details
				className='group print:hidden overflow-hidden rounded-xl border border-[#e5e7eb] bg-white shadow-sm dark:border-[#2a3441] dark:bg-[#151f2b]'
				open={isOpen}
			...
			{/* Print View */}
			<div className='hidden print:block overflow-hidden rounded-xl border border-[#e5e7eb] bg-white shadow-sm mb-6'>
				<div className='border-t border-[#f0f2f4] bg-[#fcfcfc] p-5 dark:border-[#2a3441] dark:bg-[#1a2432]'>
					<div className='hidden print:flex items-start justify-between gap-4 mb-4'>
						<div className='flex flex-col gap-1'>
							<span className='text-xs font-semibold uppercase tracking-wide text-[#617289] dark:text-[#9ca3af]'>
								Question {index + 1}
							</span>
